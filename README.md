...
- `danklinux-nvidia` - Same as `danklinux`, but built off of `ublue/base-nvidia` to install drivers for NVIDIA graphics cards.
...
```bash
sudo bootc switch --enforce-container-sigpolicy ghcr.io/hecknt/danklinux-dx:latest
```
